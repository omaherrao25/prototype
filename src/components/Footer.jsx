    ...
    <footer className="overflow-hidden bg-[#314D3D] text-[#F6F1E9]">
      ...
      <div className="border-t border-[#F6F1E9]/10 border-b border-[#F6F1E9]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-6 gap-x-4 lg:divide-x divide-[#F6F1E9]/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-10">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            ...
            <p className="font-body text-[14px] text-[#F6F1E9]/60 leading-relaxed mb-8 max-w-[260px]">
            ...
            <div className="flex items-center gap-2 mb-8">
              {Object.entries(SocialSVGs).map(([name, Icon]) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full bg-[#F6F1E9]/5 hover:bg-[#9C795C] border border-[#F6F1E9]/10 hover:border-[#9C795C] flex items-center justify-center text-[#F6F1E9]/70 hover:text-white transition-all duration-300"
                >
                  <Icon />
                </motion.a>
              ))}
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            ...
            {subscribed ? (
              <div className="bg-[#9C795C]/20 border border-[#9C795C]/40 rounded-full px-5 py-3.5 text-[#F6F1E9] text-sm font-body text-center">
                ✓ Welcome to Ecoveda!
              </div>
            ) : (
              <form onSubmit={handleSubscribe} className="space-y-3">
                <input
                  ...
                  className="w-full bg-[#F6F1E9]/5 border border-[#F6F1E9]/15 text-[#F6F1E9] placeholder:text-[#F6F1E9]/30 text-[13px] font-body rounded-full px-5 py-3.5 outline-none focus:border-[#9C795C] transition-colors"
                />
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 bg-[#9C795C] hover:bg-[#85654C] text-white text-[11px] uppercase tracking-[0.15em] font-body font-semibold py-3.5 rounded-full transition-colors"
                >
      ...
      <div className="border-t border-[#F6F1E9]/10 bg-[#253A2E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-body text-[12px] text-[#F6F1E9]/40 text-center sm:text-left">
            © {new Date().getFullYear()} Ecoveda. All rights reserved. Handmade in India.
          </p>
          {/* Payment icons */}
          <div className="flex items-center gap-3">
            {paymentIcons.map(({ name, Icon }) => (
              <div key={name} className="flex items-center justify-center text-[#F6F1E9]/30 hover:text-[#F6F1E9]/80 transition-all duration-300 cursor-pointer" aria-label={name} title={name}>
                <Icon size={28} />
              </div>
            ))}
          </div>
