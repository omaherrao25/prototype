    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 lg:mb-20">
          ...
          >
            Frequently Asked <span className="italic text-[#314D3D]">Questions</span>
          </motion.h2>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            <motion.div
              ...
              className="border-b border-[#1E1E1E]/10"
            >
              <button
                onClick={() => setOpenIndex(openIndex === i ? null : i)}
                className="w-full py-6 flex items-center justify-between text-left group"
              >
                <h3 className="font-heading text-lg sm:text-xl font-normal text-[#1E1E1E] group-hover:text-[#314D3D] transition-colors pr-8">
                  {faq.question}
                </h3>
                <span className="text-[#314D3D]/50 group-hover:text-[#314D3D] transition-colors flex-shrink-0">
              ...
              <AnimatePresence>
                {openIndex === i && (
                  ...
                  >
                    <p
                      className="pb-6 text-[#1E1E1E]/55 text-[14.5px] leading-relaxed pr-8 lg:pr-12"
                      style={{ fontFamily: "'Manrope', sans-serif" }}
                    >
                      {faq.answer}
                    </p>
