...
export default function Contact() {
  ...
  return (
    <div className="bg-white min-h-screen font-body text-[#1E1E1E]">
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-[#FAF8F3]/30">
      ...
      <section id="contact-form" className="py-12 md:py-16 lg:py-20">
      ...
      <section className="py-12 md:py-16 border-t border-[#E9E4DC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            variants={staggerContainer}
            initial="hidden"
      ...
      {/* 5. FINAL CTA BANNER */}
      <section className="py-12 md:py-16 lg:py-20 relative bg-white overflow-hidden">
